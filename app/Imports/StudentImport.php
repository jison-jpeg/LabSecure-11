...
class StudentImport implements ToModel, WithHeadingRow, WithValidation, SkipsOnFailure
{
    ...
    public function model(array $row)
    {
        ...
        // Increment successful import count for valid records
        ...
        return new User([
            ...
            'role_id'         => optional($role)->id, // Assign "student" role by default
            'college_id'      => $college->id,
            'department_id'   => $department->id,
            'section_id'      => Section::where('name', $row['section'])->first()->id ?? null, // Set section if provided
    ...
    public function rules(): array
    {
        return [
            ...
            'section'     => 'nullable|string|max:255', // Section is optional
        ];
    }
