                ...
                <div class="modal-body">
                    <form wire:submit.prevent="{{ $editForm ? 'update' : 'save' }}" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-md-6">
                            ...
                            <select wire:model.lazy="college_id" id="college_id" class="form-select @error('college_id') is-invalid @enderror" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select wire:model.lazy="department_id" id="department_id" class="form-select @error('department_id') is-invalid @enderror" required>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">{{ $editForm ? 'Save Changes' : 'Create Faculty' }}</button>
                    </div>
                </form>
            </div>
        </div>
