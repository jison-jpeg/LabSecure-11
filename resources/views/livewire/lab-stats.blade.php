            ...
            <div class="card-body">
                ...
                <script>
                    document.addEventListener("DOMContentLoaded", () => {
                        ...
                        const series = types.map(type => (type.available / type.total) *
                        100); // Calculate percentage of available labs
                        ...
                        new ApexCharts(document.querySelector("#radialBarChart"), {
                                    ...
                                    dataLabels: {
                                        ...
                                        total: {
                                            ...
                                            formatter: function() {
                                                ...
                                                return types.reduce((acc, type) => acc + type.total,
                                                0); // Sum of all labs
                                            }
                                        }
                                    }
                            ...
                            tooltip: {
                                ...
                                y: {
                                    formatter: function(val, opts) {
                                        const totalLabs = types[opts.seriesIndex]
                                        .total; // Get the total labs for the hovered type
