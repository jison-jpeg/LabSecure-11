                ...
                <div class="modal-body">
                    ...
                    <form wire:submit.prevent="save" class="row g-3 needs-validation" novalidate>
                        <div class="col-md-4">
                            ...
                            <select wire:model.lazy="subject_id" class="form-select @error('subject_id') is-invalid @enderror" name="subject_id">
                        ...
                        <div class="col-md-4">
                            ...
                            <select wire:model.lazy="instructor_id" class="form-select @error('instructor_id') is-invalid @enderror" name="instructor_id">
                        ...
                        <div class="col-md-4">
                            ...
                            <select wire:model.lazy="laboratory_id" class="form-select @error('laboratory_id') is-invalid @enderror" name="laboratory_id">
                        ...
                        <div class="col-md-4">
                            ...
                            <select wire:model.lazy="days_of_week" multiple class="form-select @error('days_of_week') is-invalid @enderror" name="days_of_week">
